...
async def generate_review_feedback(input: dict[str, Any]) -> ReviewFeedback:
    ...
    try:
        ...
        overall_assessment = (
            "This PR introduces valuable improvements but requires attention to "
            "security and code quality issues. The changes are well-structured "
            "but need some refinements before merging."
        )
        ...
        critical_issues = len(
            [
                v
                for v in security_scan.vulnerabilities
